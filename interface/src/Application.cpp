    ...
    _sampleSound(nullptr)
{
...

    {
        ...
        // setCrashAnnotation("sentry[contexts][gpu][memory_size]", std::to_string(gpuIdent->getMemory()));
...
void Application::onDesktopRootContextCreated(QQmlContext* surfaceContext) {
    ...
    surfaceContext->setContextProperty("TivoliAbout", AboutUtil::getInstance());
...
void Application::registerScriptEngineWithApplicationServices(const ScriptEnginePointer& scriptEngine) {
    ...
    scriptEngine->registerGlobalObject("TivoliAbout", AboutUtil::getInstance());
