...
public:
    ...
    virtual QVariantMap toVariantMap() const override {
        ...
        toReturn[QStringLiteral("parabolicDistance")] = parabolicDistance;
        ...
        toReturn[QStringLiteral("parabola")] = PickResult::toVariantMap();
        toReturn[QStringLiteral("extraInfo")] = extraInfo;
        return toReturn;
    }
