 ...
 * @property {Vec3} direction - The direction the light is shining.
 * @property {boolean} castShadows=true - <code>true</code> if shadows are cast, <code>false</code> if they aren't. Shadows 
