...
const uint64_t MAX_UPDATE_RENDERABLES_TIME_BUDGET = 8200; 
const uint64_t MIN_SORTED_UPDATE_RENDERABLES_TIME_BUDGET = 8200;  
const uint64_t MAX_UPDATE_AVATARS_TIME_BUDGET = 2000; // usec TIVOLI was 2000
