...
public:
    ...
    bool readFromStream(uint64_t streamLength, QDataStream& inputStream, const bool isImport = false);
    bool readJSONFromStream(uint64_t streamLength, QDataStream& inputStream, const bool isImport = false);
