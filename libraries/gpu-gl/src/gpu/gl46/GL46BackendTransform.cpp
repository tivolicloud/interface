...
void GL46Backend::initTransform() {
...
void GL46Backend::transferTransformState(const Batch& batch) const {
...
void GL46Backend::updateTransform(const Batch& batch) {
