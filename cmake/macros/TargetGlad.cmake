...
macro(TARGET_GLAD)
    if (ANDROID)
        ...
        if (APPLE)
            find_library(MESA_LIBRARY_RELEASE glapi PATHS ${VCPKG_INSTALL_ROOT}/lib NO_DEFAULT_PATH REQUIRED)
            select_library_configurations(MESA)
            list(APPEND GLAD_EXTRA_LIBRARIES ${MESA_LIBRARY})
        else()
