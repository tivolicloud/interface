...
macro(TARGET_STEAMWORKS)
    ...
    elseif (APPLE)
        add_paths_to_fixup_libs("${VCPKG_INSTALL_ROOT}/lib/steam")
        add_custom_command(TARGET ${TARGET_NAME}
            COMMAND ${CMAKE_COMMAND} -DINSTALL_NAME_LIBRARY_PATH=${STEAMWORKS_LIBRARY_RELEASE} -P ${EXTERNAL_PROJECT_DIR}/MacOSInstallNameChange.cmake
