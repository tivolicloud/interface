...
macro(TARGET_NVTT)
    if (ANDROID)
        ...
        find_library(NVTT_LIBRARY_RELEASE nvtt PATHS ${VCPKG_INSTALL_ROOT}/lib/static NO_DEFAULT_PATH)
        find_library(NVTT_LIBRARY_DEBUG nvtt PATHS ${VCPKG_INSTALL_ROOT}/debug/lib/static NO_DEFAULT_PATH)
