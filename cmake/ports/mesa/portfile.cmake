...
# tivoli: lets force to shared because there's issues with static
...
if(VCPKG_TARGET_IS_OSX)
    # tivoli: strange mac bug where libglapi isnt relatively linked to itself
    # also happens for libOSMesa but lets ignore that, we dont need it.
    find_program(
        INSTALL_NAME_TOOL
        install_name_tool
    ...
    vcpkg_execute_build_process(
        COMMAND ${INSTALL_NAME_TOOL} -id @rpath/libglapi.0.dylib libglapi.0.dylib
        WORKING_DIRECTORY "${CURRENT_PACKAGES_DIR}/lib"
        LOGNAME "make-build-fix-rpath-${RELEASE_TRIPLET}"
    )
    # okay lets just delete libOSMesa
    file(REMOVE ${CURRENT_PACKAGES_DIR}/lib/libOSMesa.8.dylib)
    file(REMOVE ${CURRENT_PACKAGES_DIR}/lib/libOSMesa.dylib)
endif()