...
find_library(CRASHPAD_LIBRARY_RELEASE crashpad PATH_SUFFIXES "lib" HINTS ${CRASHPAD_SEARCH_DIRS})
find_library(CRASHPAD_BASE_LIBRARY_RELEASE base PATH_SUFFIXES "lib" HINTS ${CRASHPAD_SEARCH_DIRS})
find_library(CRASHPAD_UTIL_LIBRARY_RELEASE util PATH_SUFFIXES "lib" HINTS ${CRASHPAD_SEARCH_DIRS})

find_library(CRASHPAD_LIBRARY_DEBUG crashpad PATH_SUFFIXES "debug/lib" HINTS ${CRASHPAD_SEARCH_DIRS})
find_library(CRASHPAD_BASE_LIBRARY_DEBUG base PATH_SUFFIXES "debug/lib" HINTS ${CRASHPAD_SEARCH_DIRS})
find_library(CRASHPAD_UTIL_LIBRARY_DEBUG util PATH_SUFFIXES "debug/lib" HINTS ${CRASHPAD_SEARCH_DIRS})
